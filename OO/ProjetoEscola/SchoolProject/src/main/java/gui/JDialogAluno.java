...
public class JDialogAluno extends javax.swing.JDialog {
    ...
    private Integer cpfEscolhido;
    private Student alunoEditando;
...
public JDialogAluno(java.awt.Dialog parent, boolean modal) {
    super(parent, modal);
    initComponents();
    setLocationRelativeTo(parent);
    initData();
...
private void initData() {
    ...
    this.alunoEditando = new Student();
    this.editando = false;
    this.cpfEscolhido = 0;
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
       Student novaAluno = this.camposParaObjeto();

        if (this.editando == true) {
            this.servico.update(cpfEscolhido, novaAluno);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Integer CPFEscolhido = Integer.parseInt(JOptionPane.showInputDialog("Informe o CPF do aluno que deseja excluir:", ""));

        Student p = (Student) this.servico.find(CPFEscolhido);

        if (p == null) {
            JOptionPane.showMessageDialog(this, "Não existe aluno com este CPF.");
        } else {
            this.servico.remove(CPFEscolhido);
    ...
    private void btnEdtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEdtActionPerformed
        ...
        this.alunoEditando = (Student) this.servico.find(CPFEscolhido);
    ...
    public void atualizarTabela() {
        ...
        servico.salvarNoArquivo("ListagemAlunos.csv");
    }
