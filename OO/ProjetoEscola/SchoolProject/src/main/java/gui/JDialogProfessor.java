...
import trabalho.schoolproject.Management.TeacherManager;
...
public class JDialogProfessor extends javax.swing.JDialog {
    ...
    private Teacher professorEditando;
    private TeacherManager gerenciaP;
    ...
    public JDialogProfessor(java.awt.Frame parent, boolean modal) {
        ...
        this.editando = false;
        this.cpfAntigo = 0;
        this.professorEditando = new Teacher();
        this.gerenciaP = new TeacherManager();
        this.servico = new ServiceManager(gerenciaP);
        
        servico.carregarDoArquivo("ListagemProfessores.csv");
    ...
    public JDialogProfessor(JFrameDepartamento aThis, boolean b, Teacher newProfessor) {
    ...
    private void btnEdtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEdtActionPerformed
        Integer cpfEscolhido = Integer.parseInt(JOptionPane.showInputDialog("Informe o CPF que deseja EDITAR:", ""));

        this.professorEditando = (Teacher) this.servico.find(cpfEscolhido);
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        Teacher novoProf = this.camposParaObjeto();

        if (this.editando) {
            this.servico.update(cpfAntigo, novoProf);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        Teacher p = (Teacher) this.servico.find(cpfEscolhido);
    ...
    TMCadProfessor tmcadProf = new TMCadProfessor(gerenciaP.getTeachers());
    grdProfessor.setModel(tmcadProf);
    servico.salvarNoArquivo("ListagemProfessores.csv");
}
